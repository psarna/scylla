...
future<> service::client_state::maybe_update_per_service_level_params() {
    if (_sl_controller && _user && _user->name) {
        ...
        const qos::service_level_options& slo = *slo_opt;
        _timeout_config.read_timeout = slo.timeout.value_or(_default_timeout_config.read_timeout);
        _timeout_config.write_timeout = slo.timeout.value_or(_default_timeout_config.write_timeout);
        _timeout_config.range_read_timeout = slo.timeout.value_or(_default_timeout_config.range_read_timeout);
        _timeout_config.counter_write_timeout = slo.timeout.value_or(_default_timeout_config.counter_write_timeout);
        _timeout_config.truncate_timeout = slo.timeout.value_or(_default_timeout_config.truncate_timeout);
        _timeout_config.cas_timeout = slo.timeout.value_or(_default_timeout_config.cas_timeout);
        _timeout_config.other_timeout = slo.timeout.value_or(_default_timeout_config.other_timeout);
    }
}
