...
public:
    ...
    class restrictions_filter {
        ...
        mutable uint32_t _rows_fetched_for_previous_partition;
    ...
    public:
        explicit restrictions_filter(::shared_ptr<restrictions::statement_restrictions> restrictions,
                ...
                uint32_t rows_fetched_for_previous_partition = 0)
            ...
            , _rows_fetched_for_previous_partition(rows_fetched_for_previous_partition)
