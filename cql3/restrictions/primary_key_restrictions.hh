...
using primary_key_restrictions = typename std::conditional<std::is_same_v<ValueType, partition_key>, partition_key_restrictions, clustering_key_restrictions>::type;
