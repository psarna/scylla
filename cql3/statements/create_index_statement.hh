...
class create_index_statement : public schema_altering_statement {
    ...
    const std::vector<::shared_ptr<column_identifier::raw>> _pk_columns;
...
public:
    create_index_statement(::shared_ptr<cf_name> name, ::shared_ptr<index_name> index_name,
            ...
            ::shared_ptr<index_prop_defs> properties, bool if_not_exists, std::vector<::shared_ptr<column_identifier::raw>> pk_columns);
