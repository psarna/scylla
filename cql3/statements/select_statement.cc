                          ...
                          const query_options& options)
{
    ...
    bool restrictions_need_filtering = _restrictions->need_filtering();
    ++_stats.reads;
    ...
    bool aggregate = _selection->is_aggregate();
    bool nonpaged_filtering = restrictions_need_filtering && page_size <= 0;
...
{
    bool restrictions_need_filtering = _restrictions->need_filtering();
    bool fast_path = !needs_post_query_ordering() && _selection->is_trivial() && !restrictions_need_filtering;
    if (fast_path) {
