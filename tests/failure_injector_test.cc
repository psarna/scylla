...
BOOST_AUTO_TEST_CASE(test_cancel) {
    ...
    injector.check_breakpoint("bp1");
    BOOST_REQUIRE_THROW(injector.check_breakpoint("bp2"), std::runtime_error);
}
...
SEASTAR_TEST_CASE(test_sleep) {
    ...
    injector.check_breakpoint("bp1", f);
...
SEASTAR_TEST_CASE(test_wait_on_condition) {
    ...
    static debug::failure_injector injector;
