...
public:
    ...
    // NOTICE(sarna): This copy constructor is explicit, because it involves deep copying
    // of the computation object. Computation has a strict ownership policy provided by
