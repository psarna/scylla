...
public:
    ...
    future<> start() {
        _started = parallel_for_each(_db.get_non_system_column_families(), [this] (lw_shared_ptr<table> table) {
            return table->generate_mv_updates_from_staging_sstables(_proxy, _as);
        });
