...
delete_ghost_rows_visitor::delete_ghost_rows_visitor(service::storage_proxy& proxy, service::query_state& state, view_ptr view, const cql3::query_options& options, db::timeout_clock::duration timeout_duration)
        : _proxy(proxy)
        , _state(state)
        , _options(options)
