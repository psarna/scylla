...
public:
    ...
    schema_builder& with_column(bytes name, data_type type, column_kind kind, column_id component_index, column_view_virtual view_virtual = column_view_virtual::no, std::optional<column_computed_info> computed = std::nullopt);
    schema_builder& with_computed_column(bytes name, data_type type, column_kind kind, column_computed_info computed);
    ...
    schema_builder& mark_column_computed(bytes name, column_computed_info computed);
