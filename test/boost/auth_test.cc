...
SEASTAR_TEST_CASE(test_alter_with_timeouts) {
    ...
    return do_with_cql_env_thread([] (cql_test_env& e) {
        ...
        cquery_nofail(e, "CREATE SERVICE LEVEL sl2 WITH range_read_timeout = 0s AND write_timeout = 0s");
        cquery_nofail(e, "ATTACH SERVICE LEVEL sl2 TO user2");
        cquery_nofail(e, "ALTER SERVICE LEVEL sl WITH range_read_timeout = 1s and write_timeout = 1s");
