...
class digester final {
    std::variant<noop_hasher, md5_hasher, xx_hasher, xx_hasher_with_null_digest> _impl;
...
public:
    explicit digester(digest_algorithm algo) {
        ...
        case digest_algorithm::xxHash:
            _impl = xx_hasher();
            break;
        case digest_algorithm::xxHash_with_null_digest:
            _impl = xx_hasher_with_null_digest();
            break;
