...
### ARNs and tags
* Various features use ARN (Amazon Resource Names), which are represented
  in the following format: arn:scylla:alternator:${KEYSPACE\_NAME}:scylla:table/${TABLE\_NAME}
