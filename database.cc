    ...
    if (_config.enable_metrics_reporting) {
        ...
        auto add_row_lock_metrics = [this, ks, cf] (row_locker::single_lock_stats& stats, sstring stat_name) {
            _metrics.add_group("column_family", {
                ...
                ms::make_queue_length(sprint("row_lock_%s_operations_waiting_for_lock", stat_name), stats.operations_waiting_for_lock, ms::description(sprint("Operations waiting for %s lock", stat_name)))(cf)(ks),
